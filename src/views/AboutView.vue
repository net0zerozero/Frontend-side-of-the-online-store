<template>
    <main>
        ...
        <div class="px-4 py-5 my-5 text-center">
            <img class="d-block mx-auto mb-4" src="/images/about/hedgehog.jpg" alt="" width=1000>
            <h1 class="display-5 fw-bold text-body-emphasis">Ежик Соник</h1>
            <div class="col-lg-6 mx-auto">
                <p class="lead mb-4">Ежик Соник тот который создал нашу компанию и является со основателем всего этого. Любовь и трудолюбивость те самые качества которым радует нас он.</p>
